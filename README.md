...
2. toxic_comment_classification_LSTM_Kera.ipynb
...
3. toxic_comment_classification_BidirectionalLSTM_Kera.ipynb
- Approach: 1 Bidirectional layer, 1 pooling layer, 1 dense layer
